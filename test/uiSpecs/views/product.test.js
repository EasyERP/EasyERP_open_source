define([
    ...
    'chai-jquery',
    'sinon-chai'
], function (fixtures, ProductCollection, MainView, ThumbnailsView, ListView, CreateView, EditView, TopBarView, $, chai, chaiJquery, sinonChai) {
    'use strict';
    var expect;
        ...
        describe('Product ThumbnailsView', function () {
            ...
            describe('INITIALIZE', function () {
                ...
                it('Try to application ThumbnailsView', function (done) {
                    ...
                    expect($thisEl.find('.product').length).to.be.equals(2);
