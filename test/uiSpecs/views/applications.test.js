define([
    ...
    'sinon-chai',
    'custom'
], function (modules, fixtures, ApplicationCollection, WorkflowCollection, MainView, ListView, KanBanView, FormView, TopBarView, CreateView, EditView, $, chai, chaiJquery, sinonChai, Custom) {
    'use strict';
    var expect;
    var fakeApplication = {
        data: [
