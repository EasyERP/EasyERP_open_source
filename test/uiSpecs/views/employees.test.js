...
], function (fixtures, EmployeeModel, modules, EmployeeCollection, MainView, ListView, /* FormView,*/ ThumbnailsView, CreateView, EditView, TopBarView, eventsBinder, $, _, chai, chaiJquery, sinonChai, fakeFilters) {
    'use strict';
    var expect;
