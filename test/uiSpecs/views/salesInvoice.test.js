define([
    ...
    'sinon-chai',
    'custom'
], function (fixtures, InvoiceCollection, MainView, ListView, TopBarView, $, chai, chaiJquery, sinonChai, Custom) {
    'use strict';
    var expect;
    ...
    var fakeInvoice = [
        {
            ...
            editedBy: {
                user: {
                    ...
                    lastAccess: "2016-04-29T13:01:29.800Z",
                    login: "admin",
            ...
            project: {
                ...
                EndDate: "2015-01-15T22:00:00.000Z",
                StartDate: "2014-11-03T22:00:00.000Z",
                ID: 49,
                bonus: [
                    {
                ...
                salesManagers: [
                    {
                        date: "2014-11-04T12:27:34.860Z",
                        _id: "5707533ecbb17f48214c76e2",
            ...
            paymentDate: "2014-12-05T00:00:00.000Z",
            ...
            invoiceDate: "2014-11-28T00:00:00.000Z",
            project: {
                _id: "55b92ad621e4b7c40f0006a4",
                EndDate: "2014-10-30T22:00:00.000Z",
                StartDate: "2014-09-21T21:00:00.000Z",
                ID: 25,
                bonus: [
                    {
                        employeeId: "55b92ad221e4b7c40f00004a",
                ...
                salesManagers: [
                    {
                        date: "2014-09-22T12:27:34.541Z",
                        _id: "5707533ecbb17f48214c76db",
                        manager: "55b92ad221e4b7c40f00004a"
                    }
                ]
            },
