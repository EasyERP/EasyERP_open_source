define([
    ...
    'custom',
    'async'
], function (modules, fixtures, ProjectModel, ProjectCollection, MainView, ListView, FormView, ThumbnailsView, topBarView, CreateView, EditView, $, chai, chaiJquery, sinonChai) {
    'use strict';
