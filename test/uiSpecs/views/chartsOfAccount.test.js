        ...
        describe('ChartsOfAccount list view', function () {
            ...
            describe('INITIALIZE', function () {
                ...
                it('Try to create ChartsOfAccount list view', function (done) {
                    ...
                    expect($thisEl.find('#chartOfAccount')).to.exist;
                    expect($thisEl.find('#chartOfAccount > tr').length).to.not.equals(0);
                ...
                it('Try to delete item with changes(cancelChanges)', function () {
                    var $code = $thisEl.find('#chartOfAccount > tr:nth-child(1) > td[data-content="code"]');
                    var $account = $thisEl.find('#chartOfAccount > tr:nth-child(1) > td[data-content="account"]');
                    var $deleteBtn;
                    var $codeInput;
                ...
                it('Try to delete item with good error response', function () {
                    ...
                    expect($thisEl.find('#chartOfAccount > tr:nth-child(1) > td:nth-child(3)').text()).to.be.equals('101200');
                });
