define([
    ...
    "dataService",
       ...
       function (DashboardTemplate, projectTemplate, custom, dataService, helpers) {
           var ContentView = Backbone.View.extend({
               ...
               renderProjectPM:function(){
                   ...
                   if (App.cashedData && App.cashedData.projectInfo){
                       collection = custom.retriveFromCash('projectInfo');

                       $("#ProjectPMContent").append(template({collection: collection, startNumber: 0, currencySplitter: helpers.currencySplitter}));
                       ...
                       this.populateProjectForDashboard("/getProjectPMForDashboard",function(collection){
                           ...
                           custom.cashToApp('projectInfo', collection);
