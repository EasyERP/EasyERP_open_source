define([
    ...
    'moment',
    'constants'
], function (Backbone, $, _, DashboardTemplate, d3, common, dataService, moment, CONSTANTS) {
    'use strict';
    ...
    var ContentView = Backbone.View.extend({
        ...
        changeTab: function (e) {
            ...
            var n = $targetEl.parents('.chart-tabs').find('li').index($targetEl.parent());

            $targetEl.closest('.chart-tabs').find('a.active').removeClass('active');
        ...
        newRangeSource: function (e) {
            var $targetEl = $(e.target);
            var $parent = $targetEl.closest('.choseDateRangeSource');
            var type = $parent.attr('data-type');

            $targetEl.parent().find('.active').removeClass('active');
            $targetEl.addClass('active');

            this.dateRangeSource = $targetEl.data('day');
        ...
        resizeHandler: function () {
            ...
            if (!self.source) {
                return dataService.getData("/sources", null, function (response) {
            ...
            if ($(window).width() < CONSTANTS.DEFAULT_SCREEN_WIDTH) {
