define([
    ...
    function (listViewBase, paginationTemplate, listTemplate, stagesTamplate, CreateView, listItemView, editView, currentModel, contentCollection, filterView, common) {
        return listViewBase.extend({
