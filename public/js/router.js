define([
    ...
    var appRouter = Backbone.Router.extend({
        ...
        routes: {
            ...
            'easyErp/:contentType/tform(/:modelId)(/c=:countPerPage)(/filter=:filter)'                      : 'goToTForm', // FixMe chenge to required Id after test
        ...
        goToTForm: function (contentType, modelId, countPerPage, filter) {
            var self = this;
