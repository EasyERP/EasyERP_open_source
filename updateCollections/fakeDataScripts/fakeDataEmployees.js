...
fakeNamesString.forEach(function(elem){
    cleanFakeNames.push(cleanString(elem));
});
fakeSurnamesString.forEach(function(elem){
    cleanFakeSurnames.push(cleanString(elem));
});
